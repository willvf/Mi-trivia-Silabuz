...
# Ejemplo 1
  ...
  time.sleep(2)
  print ("Primero Scaneare tu nivel de pelea, Luego con  Cada respuesta correcta incrementa mil de nivel de pelea\033[39m\n")

  time.sleep(2)

  print ("Scaneando nivel de pelea....\033[39m\n")

  time.sleep(3)
 
  print ("\n\033[32mScaner completado al 100%\033[39m\n")

  time.sleep(4)

  print ("\033[33mTu nivel de pelea actual es de ", puntaje, "\033[39m\n") 
...
# Almacenamos la respuesta del usuario en la variable "respuesta_15"
  ...
  print ("\033[33mtu nivel de pelea ahora es de\033[39m", puntaje, "\n")
